check: build/bin/catalog
	...
	build/bin/catalog update --registry build/registry.yaml --configuration build/configuration.yaml --output build/ephemeral/schema --definitions build/ephemeral/schema
